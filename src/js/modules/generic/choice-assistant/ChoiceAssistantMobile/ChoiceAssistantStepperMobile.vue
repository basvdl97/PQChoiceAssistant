    ...
    <div class="w-full max-w-[500px] px-4 flex items-start">
        ...
        <div class="flex-1 px-8 flex flex-col items-center">
            ...
            <div class="w-full flex justify-center mt-2 gap-3">
                <!-- ball -->
                <div v-for="(question, j) in questions[current_question[0]].content" :key="j" class="w-6 h-6 rounded-full border border-secondary text-secondary leading-none flex items-center justify-center relative" :class="{
        ...
        <div @click="gotoNextQuestion" class="" :class="{
