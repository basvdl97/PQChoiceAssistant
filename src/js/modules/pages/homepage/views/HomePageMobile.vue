<template>
    <div class="w-full flex flex-col items-center pt-8 px-4">
        ...
        <div @click="$router.push({name: 'KEMPageRoute'})" class="w-full max-w-[300px] mb-4 bg-secondary text-white p-3 rounded-lg cursor-pointer">
        ...
        <div @click="$router.push({name: 'DSSPageRoute'})" class="w-full max-w-[300px] mb-4 bg-quadrinary text-white p-3 rounded-lg cursor-pointer">
    ...
    <div class="fixed z-10 bottom-0 w-[100vw] h-2/4 flex flex-col transition-transform duration-500 ease-in-out" :class="{
        ...
        <div class="w-full px-8 pt-8 bg-white flex-1  leading-tight text-sm">
            ...
            <div class="mt-8 leading-none  text-justify">
                ...
                All information entered in the PQChoiceAssistant is handled client-side, and all calculations are done
