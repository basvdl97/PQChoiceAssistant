        ...
        <div class="w-full max-w-7xl">
            ...
            <template v-if="tab == 'kem'">
                <table class="w-full mt-16">
                    ...
                    <tbody>
                        <tr v-for="(characteristic, i) in Object.keys(kem_education_table)" class="text-secondary"
                            :class="{
                                'bg-tertiary': i % 2 == 0,
                                'bg-white': i % 2 != 0,
                            }">
                            <td>
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-10 h-10 bg-secondary rounded-full text-white flex leading-none items-center justify-center font-bold text-lg">
                                        {{ i + 1 }}
                                    </div>
            ...
            <template v-else-if="tab == 'dss'">
                <table class="w-full mt-16">
                    ...
                    <tbody>
                        <tr v-for="(characteristic, i) in Object.keys(dss_education_table)" class="text-secondary"
                            :class="{
                                'bg-tertiary': i % 2 == 0,
                                'bg-white': i % 2 != 0,
                            }">
