export const questions = [
        ...
        "content": [
            ...
            },
            {
                ...
                "description": {
                    ...
                    "EN": "If your use case is time-sensitive, choose the first answer. If your use case has no strict time constraints in key generation, signing and verifying, it can make sense to go for a less efficient algorithm for the benefit of more maturity."
                },
                "additional_information": {
                    "NL": "NTB",
                    "EN": "TBD"
    ...
    },
    {
        ...
        "content": [
            ...
            },
            {
                ...
                "expert_level": true,
                "description": {
                    "NL": "Sommige PQC algoritmen hebben hardware ondersteuning nodig voor floating point arithmetic, om te garanderen dat het algoritme veilig is ge\u00efmplementeerd.",
        ...
        "content": [
            {
                ...
                "expert_level": false,
                "description": {
                    "NL": "De nieuwe wiskundige problemen waarop de quantumveilige cryptografie gebaseerd zijn, resulteert vaak in langere cryptografische sleutels en handtekeningen dan de quantumkwetsbare algoritmen zoals RSA en ECC. Dit kan leiden tot het gebruik van meer geheugen en tijd.",
            ...
            },
            {
                ...
                "expert_level": true,
                "description": {
                    "NL": "De nieuwe wiskundige problemen waarop de quantumveilige cryptografie gebaseerd zijn, resulteert vaak in langere cryptografische sleutels en handtekeningen dan de quantumkwetsbare algoritmen zoals RSA en ECC. De geheime sleutel is nodig tijdens het maken van de handtekening en de publieke sleutel voor de verificatie. De handtekening en \u00e9\u00e9n van de sleutels moet daartoe tegelijkertijd in de RAM van het apparaat passen.",
    ...
    },
    {
        ...
        "content": [
            ...
            },
            {
                ...
                "expert_level": true,
                "description": {
                    "NL": "Sommige quantumveilige cryptografische algoritmen hebben een grotere handtekening dan de huidige quantumkwetsbare cryptografie en vereisen daarom meer bandbreedte. Dit is in het bijzonder relevant als uw toepassing tijdsgevoelig is.",
    ...
    },
    {
        ...
        "content": [
            ...
            },
            {
                ...
                "expert_level": true,
                "description": {
                    "NL": "Sommige cryptografische operaties kunnen makkelijker constant time gemaakt worden dan anderen.",
    ...
    },
    {
        ...
        "content": [
            {
                "question": {
                    "NL": "Heeft uw toepassing maar een beperkt aantal handtekeningen nodig en kan tegelijkertijd ook de cryptografische staat veilig bijgehouden worden?",
